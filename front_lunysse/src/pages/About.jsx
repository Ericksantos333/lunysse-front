...
export const About = () => {
      ...
      <section className="text-center py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="w-24 h-24 bg-white rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl">
            <img src="https://static.vecteezy.com/system/resources/previews/011/718/509/original/brain-logo-template-design-brainstorm-logo-ideas-neurology-logo-think-idea-concept-free-vector.jpg" alt="Lunysse" className="w-16 h-16 rounded-2xl" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-dark mb-6">Sobre o Lunysse</h1>
          <div className="bg-blue-300 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-xl text-black">
  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
    {/* Missão */}
    <div className="bg-blue-300 rounded-3xl p-8 border border-blue-500 shadow-xl text-black">
...
<section className="py-12">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      {/* Lista de problemas */}
      <div className="bg-blue-300 rounded-2xl p-6 border border-blue-500 shadow-lg text-black">
        <h3 className="text-xl font-semibold mb-4">Desafios Identificados</h3>
      ...
      {/* Lista de soluções */}
      <div className="bg-blue-300 rounded-2xl p-6 border border-blue-500 shadow-lg text-black">
        <h3 className="text-xl font-semibold mb-4">Nossas Soluções</h3>
        <ul className="space-y-3">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
               <div key={index} className="bg-blue-300 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg text-black">
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      {values.map((value, index) => (
        <div
          key={index}
          className="bg-blue-300 rounded-2xl p-6 border border-blue-500 shadow-lg text-center text-black"
        >
