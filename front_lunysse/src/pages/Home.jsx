    ...
    <div>
        ...
        <div>
          ...
          >
            ...
            <div className="w-32 h-32 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl overflow-hidden bg-white">
              <img
                src="https://tse4.mm.bing.net/th/id/OIP.h6O7cRiy2k2NFld5fiwAXAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
                alt="Lunysse"
      ...
      <section id="features" className="min-h-screen flex items-center py-20">
        <div className="w-full">
          ...
          {/* Título e frase da seção */}
          <div className="text-center mb-16">
            <motion.div
              initial={{ opacity: 0, y: 20 }}   // começa escondido
              whileInView={{ opacity: 1, y: 0 }} // aparece quando rolar até aqui
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-7xl mx-auto ">
            {features.map((feature, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1, duration: 0.6 }} // aparece em sequência
                viewport={{ once: true }}
                className="text-center  rounded-3xl bg-[#1f2937] p-6 shadow-2xl bg-blue-400"
              >
                {/* Bolinha com o ícone */}
                <div className="w-20 h-20 bg-gradient-to-br from-light to-accent rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
                  <feature.icon className="w-10 h-10 text-white" />
                </div>
                {/* Nome e explicação do recurso */}
